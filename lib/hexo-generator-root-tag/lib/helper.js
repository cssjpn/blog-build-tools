...
function listRootTagHelper(options) {
  ...
  const style = Object.prototype.hasOwnProperty.call(options, 'style') ? options.style : 'list';
  ...
  let result = '';
  const self = this;
  const rootTagOption = Object.prototype.hasOwnProperty.call(options, 'root_tag_generator') ? Object.assign(defaultOption, options.root_tag_generator) : defaultOption;
